...
[![Build Status](https://img.shields.io/github/checks-status/k3llla/hello-world-api/master?color=black&style=for-the-badge&logo=github)][github-actions]
[![Code Coverage](https://img.shields.io/codecov/c/github/k3llla/hello-world-api?color=blue&logo=codecov&style=for-the-badge)][github-actions-tests]
...
[![License](https://img.shields.io/github/license/k3llla/hello-world-api?color=red&style=for-the-badge)][project-license]
...
```sh
git clone https://github.com/k3llla/hello-world-api
cd hello-world-api
```
</details>
...
This section will guide you to setup a fully-functional local copy of `hello-world-api`
...
from [`hello-world-api's` Makefile][makefile-file] (most of which are
OS-independent)!

### Installing dependencies

To install all dependencies associated with `hello-world-api`, run the
command
...
The pre-commit hooks used by `hello-world-api` are located within the
...
Tests in `hello-world-api` are classified as *fast* and *slow* - depending
...
|      `run`     	| Run *hello-world-api*                           	|       NA      	|
|  `docker-gen`  	| Create production docker image for *hello-world-api* 	|     docker    	|
|  `docker-debug`  	| Create debug-friendly docker image for *hello-world-api* 	|     docker    	|
...
```text
hello-world-api_<version>_<target-os>_<architecture>.<extension>
```
...
```sh
hello-world-api_v1.2.1_windows_x86_64.exe
```
...
To run `hello-world-api` in a docker container, read the instructions in
[docker section](./docker).

### Running `hello-world-api`

To run hello-world-api, use the command
...
`hello-world-api` is powered by a template generated using [`go-template`][go-template-link]
